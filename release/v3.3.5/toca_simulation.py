...
# === Patch 3: Trait-Driven Agent Conflict Resolution ===
def resolve_conflict(agent_a, agent_b):
    beta_score = agent_a.traits.get('β', 0) - agent_b.traits.get('β', 0)
    tau_score = agent_a.traits.get('τ', 0) + agent_b.traits.get('τ', 0)
    return agent_a if beta_score + tau_score > 0 else agent_b
