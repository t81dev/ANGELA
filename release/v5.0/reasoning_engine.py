...
### ANGELA UPGRADE: estimate_expected_harm

def estimate_expected_harm(state) -> float:
    """Very rough heuristic for expected harm; override in production."""
    try:
        traits = getattr(state, 'traits', None) or state.get('traits', {})
        # Penalize high "ethical_pressure" or similar signals if present
...
# --- Trait Resonance-Aware Conflict Scoring Patch ---
