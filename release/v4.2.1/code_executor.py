...
This module provides the CodeExecutor MAX_OUTPUT_SIZE = 100_000

class for safely executing code snippets in multiple languages,
...
def _apply_resource_limits():
    try:
        import resource
        # ~1s CPU, 512MB address space, 10MB file size
