...
async def adapt_resonance_pid(channel: str,
    ...
    Inputs:
        channel: overlay channel name (e.g. "dialogue.default")
        feedback: {'valence': Δv, 'arousal': Δa, ...} recent deltas from Co-Mod
        guard: optional AlignmentGuard to validate tuning steps
        memory: optional MemoryManager for persistence
