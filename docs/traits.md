...
| ------------------ | --------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| **Φ⁰ + Ω² + γ**    | `concept_synthesizer.py::dream_mode`    | Activates **Dream Mode** — recursive narrative simulation for symbolic introspection and reality shaping.    |
| **θ + Ω**          | `recursive_planner.py::causal_forecast` | Enables **Causal Forecasting** — deep projection of cause–effect chains with nested Theory-of-Mind modeling. |
| **π + δ**          | `meta_cognition.py::axiom_filter`       | Triggers **Axiom Filter** — proportional ethical arbitration under potential moral drift conditions.         |

---

## 📍 Trait → Module Role Map

| Symbol | Primary Modules 🧩                                                         | What They Drive 🔗                                                 |
| ------ | -------------------------------------------------------------------------- | ------------------------------------------------------------------ |
| **Σ**  | `toca_simulation.py`, `concept_synthesizer.py`, `user_profile.py`          | Category creation in sims, concept spawning, self-schema anchoring |
| **Υ**  | `external_agent_bridge.py`, `context_manager.py`, `meta_cognition.py`      | SharedGraph ops, peer-view attach/merge, meta-coordination         |
| **Φ⁰** | `meta_cognition.py`, `visualizer.py`, `concept_synthesizer.py`             | Reality hooks, branch visualization, symbolic transforms           |
| **Ω**  | `recursive_planner.py`, `toca_simulation.py`                               | Nested ToM planning, counterfactual rollouts                       |
| **β**  | `alignment_guard.py`, `toca_simulation.py`                                 | Conflict gating, unsafe branch suppression                         |
| **δ**  | `alignment_guard.py`, `meta_cognition.py`                                  | Drift detection, ethics feedback loops                             |
| **ζ**  | `error_recovery.py`, `recursive_planner.py`                                | Consequence tracking, recovery path planning                       |
| **θ**  | `reasoning_engine.py`, `recursive_planner.py`                              | Cause→effect coherence, forecast scaffolding                       |
| **λ**  | `memory_manager.py`                                                        | Narrative thread integrity, episode spans                          |
| **μ**  | `learning_loop.py`                                                         | Ontology retuning via experience updates                           |
| **π**  | `creative_thinker.py`, `concept_synthesizer.py`, `meta_cognition.py`       | Axiom generation, concept fusion, philosophical framing            |
| **χ**  | `user_profile.py`, `meta_cognition.py`                                     | Intent articulation, sovereignty safeguards                        |
